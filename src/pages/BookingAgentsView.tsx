...
export default function BookingAgentsView() {
  ...
  const { bookingAgents, invoices, addBookingAgent, updateBookingAgent, deleteBookingAgent } = useFinance();
  ...
  return (
    <div className="space-y-6 px-1 md:px-0">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900">{t('common.bookingAgents')}</h1>
