          ...
          <div className="space-y-5 text-slate-600 leading-relaxed">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc ps-5 space-y-2">
                ...
                <li><span className="font-semibold text-slate-800">Google Drive files created by FinFlow only</span> (scope: <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">drive.file</code>) — the application data file (<code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">app_data.json</code>), receipt files you upload, and invoice PDFs the app generates, all inside a dedicated <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">FinFlow Data</code> folder. This scope does <span className="font-semibold text-slate-800">not</span> allow FinFlow to see, read, or modify any other file in your Drive.</li>
                <li><span className="font-semibold text-slate-800">Gmail — send only</span> (scope: <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">gmail.send</code>) — the ability to send an email from your Gmail address. FinFlow cannot read, search, modify, or delete any of your emails.</li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc ps-5 space-y-2">
                ...
                <li><span className="font-semibold text-slate-800">Google Drive</span> serves as your personal database: FinFlow reads and writes your business records (expenses, invoices, clients, settings) to the app data file it created, uploads receipt images/PDFs you choose, and archives invoice PDFs it generates for you. All processing happens locally in your browser or app on your device.</li>
                <li><span className="font-semibold text-slate-800">Gmail send</span> is used exclusively to send an invoice email — with the invoice PDF attached — to a recipient you specify, and only at the moment you explicitly press the send button. FinFlow never sends email on its own initiative.</li>
              </ul>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc ps-5 space-y-2">
                <li>Your data is stored in <span className="font-semibold text-slate-800">your own Google Drive</span>, protected by your Google account's security. Files FinFlow creates are private to your account — the app never makes them publicly accessible or shares them by link.</li>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc ps-5 space-y-2">
                ...
                <li><span className="font-semibold text-slate-800">In Google Drive</span> — delete the <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">FinFlow Data</code> folder directly; FinFlow keeps no other copy.</li>
                <li><span className="font-semibold text-slate-800">Revoke access</span> — remove FinFlow's access to your Google account at any time at <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" className="text-indigo-600 underline hover:text-indigo-800">myaccount.google.com/permissions</a>, which immediately terminates all of the app's access to your Google user data.</li>
              </ul>
            ...
            <div className="space-y-2">
              ...
              <p>FinFlow does not use cookies or any analytics or tracking tools. We have no visibility into how you use the application.</p>
            </div>
        ...
        <section className="bg-white rounded-2xl border p-8 space-y-6" dir="rtl">
          ...
          <div className="space-y-5 text-slate-600 leading-relaxed">
            <div className="space-y-2">
              ...
              <p>FinFlow היא אפליקציית צד-לקוח שנבנתה על ארכיטקטורה של פרטיות תחילה. אנחנו לא מפעילים שרתים או מסדי נתונים משלנו: אנחנו לא שומרים, מעבדים או מעבירים את הנתונים הפיננסיים, הקבלות או המידע האישי שלך לשום שרת שבבעלותנו. כל הנתונים שלך נמצאים אך ורק בחשבון Google שלך ובמכשיר שלך.</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pe-5 space-y-2">
                ...
                <li><span className="font-semibold text-slate-800">קבצי Google Drive שנוצרו על ידי FinFlow בלבד</span> (הרשאת <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">drive.file</code>) — קובץ נתוני האפליקציה (<code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">app_data.json</code>), קבצי קבלות שאתה מעלה, וקובצי PDF של חשבוניות שהאפליקציה מפיקה — כולם בתוך תיקייה ייעודית בשם <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">FinFlow Data</code>. הרשאה זו <span className="font-semibold text-slate-800">אינה</span> מאפשרת ל-FinFlow לראות, לקרוא או לשנות שום קובץ אחר ב-Drive שלך.</li>
                <li><span className="font-semibold text-slate-800">Gmail — שליחה בלבד</span> (הרשאת <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">gmail.send</code>) — היכולת לשלוח אימייל מכתובת ה-Gmail שלך. FinFlow אינה יכולה לקרוא, לחפש, לשנות או למחוק אימיילים שלך.</li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pe-5 space-y-2">
                ...
                <li><span className="font-semibold text-slate-800">שליחת Gmail</span> משמשת אך ורק לשליחת חשבונית במייל — עם קובץ ה-PDF מצורף — לנמען שאתה מזין, ורק ברגע שאתה לוחץ במפורש על כפתור השליחה. FinFlow לעולם אינה שולחת מייל ביוזמתה.</li>
              </ul>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pe-5 space-y-2">
                <li>הנתונים שלך מאוחסנים ב-<span className="font-semibold text-slate-800">Google Drive הפרטי שלך</span>, ומוגנים על ידי אבטחת חשבון Google שלך. קבצים ש-FinFlow יוצרת הם פרטיים לחשבונך — האפליקציה לעולם אינה הופכת אותם לציבוריים ואינה משתפת אותם בקישור.</li>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc pe-5 space-y-2">
                ...
                <li><span className="font-semibold text-slate-800">מתוך Google Drive</span> — מחיקת התיקייה <code className="bg-slate-100 px-1.5 py-0.5 rounded text-sm">FinFlow Data</code> ישירות; ל-FinFlow אין שום עותק נוסף.</li>
                <li><span className="font-semibold text-slate-800">ביטול הרשאות</span> — הסרת הגישה של FinFlow לחשבון Google שלך בכל עת בכתובת <a href="https://myaccount.google.com/permissions" target="_blank" rel="noopener noreferrer" className="text-indigo-600 underline hover:text-indigo-800">myaccount.google.com/permissions</a>, המנתקת מיידית את כל גישת האפליקציה לנתוני Google שלך.</li>
              </ul>
            ...
            <div className="space-y-2">
              ...
              <p>FinFlow אינה משתמשת בעוגיות (cookies) או בכלי מעקב ואנליטיקה כלשהם. אין לנו שום נראות לגבי אופן השימוש שלך באפליקציה.</p>
            </div>
